...
## &
When preceding a variable returns the address of the variable. So & count returns the address of 'count'. Does A->B
## ((
...
Add B to A
## ->
When preceding a variable updates the variable. So 42 -> count writes the value 42 to the variable count.
## /
